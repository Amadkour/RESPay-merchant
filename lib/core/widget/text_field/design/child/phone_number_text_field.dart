...
import 'package:res_pay_merchant/core/widget/text_field/validator/child/phone_validator.dart';
                    ...
                    InkWell(
                      ...
                      child: Container(
                          ...
                          child: MyImage.svgAssets(
                              url: "assets/images/moreBottomsheet/qr pay.svg",
                              width: 5,
                              height: 5)),
                    )
                ...
                ? Directionality(
                    ...
                    child: Container(
                      ...
                      child: cubit.selectedCountry == null
                          ...
                          : InkWell(
                              onTap: () {
                                _phoneNumberBottomSheet(context: context);
                              },
                              child: Row(
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  ...List<Widget>.generate(
                    sl<CountryTypeCubit>().countryTypes.length,
                    (int index) {
                      return ListTile(
                        title: Row(
                          children: <Widget>[
                            ...
                            const Spacer(),
                            Text(
                              '+${sl<CountryTypeCubit>().countryTypes[index].phoneCode}',
                              style: Theme.of(context)
                                  .textTheme
                                  .titleMedium!
                                  .copyWith(
