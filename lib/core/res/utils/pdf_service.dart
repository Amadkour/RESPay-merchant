...
import 'package:res_pay_merchant/core/res/utils/country_util.dart';
import 'package:res_pay_merchant/core/res/utils/currency_util.dart';
...
class PdfService {
  Future<Uint8List> generate(ReceiptModel receipt) async {
          ...
          children: [
            ...
            Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
              ...
              if (receipt.beneficiary!.countryId != -1)
                Text(getCountry(receipt.beneficiary!.countryId!).name ?? ""),
            ]),
  ...
  Column _buildHeader(MemoryImage logo, ReceiptModel receipt) {
