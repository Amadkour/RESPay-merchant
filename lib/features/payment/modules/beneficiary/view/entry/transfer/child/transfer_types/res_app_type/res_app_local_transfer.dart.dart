...
class ResAppLocalTransfer extends StatefulWidget {
  const ResAppLocalTransfer({super.key});

  @override
  State<ResAppLocalTransfer> createState() => _ResAppLocalTransferState();
}

class _ResAppLocalTransferState extends State<ResAppLocalTransfer> {
                    ...
                    children: <Widget>[
                      ...
                      PhoneNumberTextField(
                        ...
                        suffixWidget: InkWell(
                          onTap: () async {
                            String phone = (await contactsList(context: context) ?? '')
