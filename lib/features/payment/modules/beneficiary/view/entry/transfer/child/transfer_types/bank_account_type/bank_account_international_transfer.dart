...
class BankAccountInternationalTransfer extends StatefulWidget {
  const BankAccountInternationalTransfer({super.key});

  @override
  State<BankAccountInternationalTransfer> createState() =>
      _BankAccountInternationalTransferState();
}

class _BankAccountInternationalTransferState
    extends State<BankAccountInternationalTransfer> {
  ...
  Widget build(BuildContext context) {
    return KeyboardActionsWidget(
      focusNodeModels: <FocusNodeModel>[
        ...
        FocusNodeModel(focusNode: benificiaryController.ibanNumberFocusNode),
      ],
            ...
            child: Form(
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  RowOfTwoTextFields(
                    onChanged: () {
                      sl<BeneficiaryCubit>().updateState();
                    },
                  ...
                  IbanText(
                    ...
                    focusNode: benificiaryController.ibanNumberFocusNode,
                    iBANError: context.watch<BeneficiaryCubit>().ibanError,
                    onChanged: (String value) {
                      benificiaryController.iban = value;
                      sl<BeneficiaryCubit>().ibanNumberState();
                    },
                  ),
                ],
              ),
