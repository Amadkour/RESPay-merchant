                ...
                children: <Widget>[
                  ...
                  ContainerWithShadow(
                    ...
                    child: Column(
                      children: <Widget>[
                              ...
                              EditButton(
                                onPressed: () {
                                  CustomNavigator.instance.popUntil(
                                      (Route<dynamic> route) =>
                                          route.settings.name ==
                                          RoutesName.transferBeneficiaries);
                                },
                              )
                            ],
                          ),
                        ...
                        if (beneficiary.type == "external") ...<Widget>[
                          Padding(
                            padding: const EdgeInsets.only(top: 24),
                            child: Row(
                              mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  ...
                  Padding(
                      ...
                      child: LoadingButton(
                        ...
                        title: tr('confirm'),
                        onTap: () async {
                          final ReceiptModel? result = await transferController
                              .createTransfer(beneficiary.uuid!);
                          if (result != null) {
                            await TransferSuccessDialog.instance.show(
                              context,
