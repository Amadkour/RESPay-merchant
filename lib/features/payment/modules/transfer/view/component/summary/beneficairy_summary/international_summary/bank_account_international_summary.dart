...
class BankAccountInternationalSummary extends StatelessWidget {
  const BankAccountInternationalSummary({super.key});
                ...
                child: Column(
                    ...
                    children: <Widget>[
                      ...
                      TitleWithSubtitleInfo(
                        haveButtonInRow: false,
                        title: "IBAN",
                        subtitle: sl<BeneficiaryCubit>().iban,
                      ),
                      const SizedBox(
                        height: 18,
                      ),
                      TitleWithSubtitleInfo(
                          haveButtonInRow: false,
                          title: "BANK NAME",
                          subtitle: sl<BankNameCubit>().currentBankName!.name),
                      const SizedBox(
                        height: 18,
                      ),
                      TitleWithSubtitleInfo(
