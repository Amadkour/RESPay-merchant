...
class WesternUnionInternationalSummary extends StatelessWidget {
  const WesternUnionInternationalSummary({super.key});
                ...
                child: Column(
                    ...
                    children: <Widget>[
                      ...
                      TitleWithSubtitleInfo(
                          ...
                          title: "COUNTRY",
                          subtitle: sl<BeneficiaryCubit>().currentCountry!.name),
                      const SizedBox(
                        height: 18,
                      ),
                      TitleWithSubtitleInfo(
