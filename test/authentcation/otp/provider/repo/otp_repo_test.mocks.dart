...
// in res_pay/test/authentcation/otp/provider/repo/otp_repo_test.dart.
...
/// A class which mocks [OtpApi].
///
/// See the documentation for Mockito's code generation for more information.
class MockOtpApi extends _i1.Mock implements _i3.OtpApi {
  MockOtpApi() {
  ...
  _i4.Future<_i2.Either<_i5.Failure, _i6.Response<Map<String, dynamic>>>>
      sendOTP(Map<String, dynamic>? verificationType) => (super.noSuchMethod(
            Invocation.method(
              #sendOTP,
              [verificationType],
            ),
