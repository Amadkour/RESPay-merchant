...
// in res_pay/test/authentcation/forget_password/provider/repository/create_password_repository_test.dart.
...
/// A class which mocks [CreateNewPasswordAPI].
///
/// See the documentation for Mockito's code generation for more information.
class MockCreateNewPasswordAPI extends _i1.Mock
    implements _i3.CreateNewPasswordAPI {
  MockCreateNewPasswordAPI() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i4.Future<_i2.Either<_i5.Failure, _i6.Response<Map<String, dynamic>>>>
      resetPassword({required Map<String, dynamic>? map}) =>
          (super.noSuchMethod(
            Invocation.method(
              #resetPassword,
              [],
