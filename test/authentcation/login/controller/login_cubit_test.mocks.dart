...
// in res_pay/test/authentcation/login/controller/login_cubit_test.dart.
...
class MockLoginRepository extends _i1.Mock implements _i3.LoginRepository {
  ...
  @override
  _i4.Future<_i2.Either<_i5.Failure, Map<String, dynamic>>> loginRepository(
          _i6.LoginInput? loginInput) =>
      (super.noSuchMethod(
        Invocation.method(
          #loginRepository,
          [loginInput],
  ...
  @override
  _i4.Future<Map<String, dynamic>> loginWithResRepository({
    String? identityId,
